<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jobdetail.aspx.cs" Inherits="yazdir.webSitesi.test.jobdetail" %>
	...
	<div class="services">
       ...
       <b>     <asp:Label ID="ilanIcerikLb" runat="server" Text="İlan İçeriği:"></asp:Label><br /></b>
        ...
        <a id="contractLink" runat="server" href="">    <asp:Label ID="contract" runat="server" Text="İlan Kontratı İçin Tıklayın..."></asp:Label></a> <br />
            ...
            <asp:Button ID="joinApp" CssClass="btn btn-primary"  runat="server" Text="İlana Başvur!" OnClick="basvuruButtonClick"   ></asp:Button>
            </center>
</div>
<!-- //events-top -->
<!-- footer -->

...
<body>
	...
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			<div class="navbar-header navbar-left">
				...
				<h1><a class="navbar-brand" href="index.html"><i><img src="images/logocuk.png" /></i> </a></h1>
					...
					<div class="signin-form profile">
						...
						<div class="login-form">
							...
							<form action="#"  method="post">
								...
								<input type="email" runat="server" id="grsMail" name="email" placeholder="Kullanıcı Adı"  required="">
								<input type="password" runat="server" id="grsPassword" name="password" placeholder="Şifre" required="">
                                   
								<div class="tp">
									
                                    
                                     <asp:Button ID="grs" runat="server" Text="Giriş Yap" OnClick="grsbuton" />
                                </div>
                        ...
                        <%-- <asp:Button ID="Button1" runat="server" Text="Kayıt Ol" OnClick="register" />--%>
	...
	<div class="banner-bottom-icons">
		...
		<div class="col-md-6 w3_banner_bottom_icons_left">
			<div class="w3_agile_banner_bottom">
				...
				<a href="#" class="hvr-rectangle-out"><img src="images/banner1.jpg" alt=" " class="img-responsive hvr-radial-in" /></a>
			</div>
		</div>
		<div class="clearfix"> </div>
	</div>
	...
	<div class="skills">
        <h3><center>Referanslarımız</center></h3>
        <br />
		...
		$(document).ready(function () {
			...
			*/
			...
			$("#signUpButton").on("click", function () {
			    var babasi = $("#signUpButton").parent();
			    var kullaniciAdi = $(babasi).find(".kullaniciadi").val();
			    var email = $(babasi).find(".email").val();
			    var password1 = $(babasi).find("#password1").val();
			    var password2 = $(babasi).find("#password2").val();

			    if (password1 != password2) {
			        alert("Eşleşen parola gir gavat");
			    } else {

			        //time to send datas to rest

			        $.ajax({
			            type: "POST",
			            url: "/Service.asmx/uyeEkle",
			            data: "kullaniciadi="+kullaniciAdi+"&email="+email+"&password1="+password1+"&password2="+password2,

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createNewsCom.aspx.cs" Inherits="yazdir.webSitesi.test.createNewsCom" %>
...
<!-- events-top -->
	<div class="services">
	   <!-- Buraya koyacaz -->
        <center>
      <p> <asp:Label ID="Label1" runat="server" Text="Haber Başlığı:"></asp:Label></p>
       <p>   <asp:TextBox ID="haberBaslikTxt" runat="server"></asp:TextBox></p>
        <p><asp:Label ID="Label2" runat="server" Text="Haber İçeriği:"></asp:Label></p>
            <p><asp:TextBox ID="haberIcerikTxt" TextMode="MultiLine" runat="server"></asp:TextBox></p>
            <asp:Button ID="haberGonder" runat="server" Text="Haberi Gönder!" OnClick="haberGonder_Click"></asp:Button>
        </center>
</div>
<!-- //events-top -->
<!-- footer -->
